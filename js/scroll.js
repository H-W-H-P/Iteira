...
// 	$('.one-third-block-third').on('mousewheel', function (e) {
// 		console.log(counter)
...
// // one-third-block-third	
// // one-third-block-second	

$(document).ready(function () {
	console.log('heh')
	$(document).on('click', '.service-menu__subheader', function () {
		console.log('heh')
		$('.service-menu__subheader').removeClass('dashed');
